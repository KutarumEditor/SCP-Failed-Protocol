-- CUSTOM FIRE SCRIPT IS MADE BY DANX (https://github.com/danx91/SCP-LC/blob/master/gamemodes/scplc/gamemode/core/fire.lua)
...
if SERVER then
	function ENTITY:Burn( time, radius, attacker, dmg, dontoverride, fulloverride )
		...
		if fulloverride or !IsValid( fire ) then
			fire = ents.Create( "fp_entity_fire" )
